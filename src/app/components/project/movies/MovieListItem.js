...
const BASE_PATH_IMAGE = "https://image.tmdb.org/t/p"
  ...
  return (
    <article className={styles.list_item}>
        <Link className={styles.link} to={Routes.MOVIE_DETAILS.replace(':id', movieData.id)}>
          <img className={styles.img} src={movieData.poster_path !== null ? BASE_PATH_IMAGE + IMAGE_SIZE + movieData.poster_path : "https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/No_image_available_450_x_600.svg/450px-No_image_available_450_x_600.svg.png"} alt={movieData.title} />
